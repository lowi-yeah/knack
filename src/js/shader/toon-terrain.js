...
let ShaderTerrain = {
  uniforms: UniformsUtils.merge( [
...

    {
      ...
      // "uLineColor1": { value: new Color( 0xAD3A64 ) },
      // "uLineColor2": { value: new Color( 0xD46D47 ) },
      // "uLineColor3": { value: new Color( 0xF6BE53 ) },
      // "uLineColor4": { value: new Color( 0xFFF856 ) },

      "uBaseColor":  { value: new Color( 0x0b0b0b ) },
      "uLineColor1": { value: new Color( 0x333333 ) },
      "uLineColor2": { value: new Color( 0x767676 ) },
      "uLineColor3": { value: new Color( 0xaaaaaa ) },
      "uLineColor4": { value: new Color( 0xfcfcfc ) },

      "ambientLight": { value: new Color( 0x111111 ) },
  ...
  fragmentShader: [
    ...
    "void main() {",
      ...
      "vec3 outgoingColor = vec3( 0.0 );",  // outgoing light does not have an alpha, the surface does
