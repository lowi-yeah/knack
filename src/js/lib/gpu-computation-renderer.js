...
let GPUComputationRenderer = function ( sizeX, sizeY, renderer ) {
  ...
  this.init = function() {
    ...
    // Check for FloatType in render targets. If not found, switch to HalfFloatType
  ...
  this.testFloatRenderTarget = function() {
    ...
    var renderTarget = this.createRenderTarget( 16, 16, undefined, undefined, undefined, undefined, FloatType );
