...
let Ocean = function ( renderer, camera, scene, options ) {
  ...
  var renderTargetType    = optionalParameter( options.USE_HALF_FLOAT, false ) ? HalfFloatType : FloatType,
      ...
      LinearClampParams   = { minFilter: LinearFilter,
      ...
      NearestClampParams  = { minFilter: NearestFilter,
      ...
      NearestRepeatParams = { minFilter:        NearestFilter,
                              magFilter:        NearestFilter,
  ...
  let fullscreeenVertexShader = ShaderLib[ "ocean_sim_vertex" ];

  // 1 - Horizontal wave vertices used for FFT
  let oceanHorizontalShader     = ShaderLib[ "ocean_subtransform" ],
      oceanHorizontalUniforms   = UniformsUtils.clone( oceanHorizontalShader.uniforms )
  ...
  this.materialOcean.uniforms.u_sunDirection    = { value: new Vector3( this.sunDirectionX, 
                                                                        this.sunDirectionY, 
                                                                        this.sunDirectionZ ) }
...
Ocean.prototype.generateMesh = function () {
  let geometry = new PlaneBufferGeometry( this.geometrySize, 
                                          this.geometrySize, 
...
Ocean.prototype.generateSeedPhaseTexture = function() {
  ...
  this.pingPhaseTexture             = new DataTexture(phaseArray, 
                                                      this.resolution, 
                                                      this.resolution, 
                                                      RGBAFormat )
